const CACHE='rasan-warranty-v12-root-icons';
const ASSETS=['./app-v12.html','./manifest-v12.json','./rassan-final-192.png','./rassan-final-512.png','./rassan-final-maskable-192.png','./rassan-final-maskable-512.png'];
